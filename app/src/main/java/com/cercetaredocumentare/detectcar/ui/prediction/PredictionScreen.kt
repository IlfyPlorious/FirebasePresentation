...
import com.cercetaredocumentare.detectcar.ui.theme.DarkGray
...
fun PredictionScreen(
    ...
    val saveReviewLoading = viewModel.saveReviewLoading.collectAsState()
        ...
        Row(
            ...
            Button(
                modifier = Modifier
                    .padding(8.dp)
                    .weight(1f)
                    .alpha(if (thumbsUp.value != null) 1f else 0.5f),
                shape = RoundedCornerShape(8.dp),
                contentPadding = PaddingValues(12.dp),
                enabled = thumbsUp.value != null,
                colors = ButtonDefaults.buttonColors(
                    contentColor = Orange,
                    containerColor = VeryLightGray,
                    disabledContainerColor = VeryLightGray,
                    disabledContentColor = Orange
                ), onClick = viewModel::sendPredictionReview
            ) {
                if (saveReviewLoading.value) {
